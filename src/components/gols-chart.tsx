...
export default function GolsChart({ data }: GolsChartProps) {
  if (!data || data.length === 0) {
    return <p className="text-center text-sm text-gray-500">Nenhum dado de gols disponível.</p>;
  }
  ...
  return (
    <section className="mb-10">
        <h3 className="text-2xl font-semibold mb-4 text-center">Gols por Jogador</h3>
            ...
            >
                ...
                >
                    ...
                    <XAxis 
                        ...
                        // Se os nomes ficarem sobrepostos, adicione estas props:
